export const registryConfig = {
   ...
   * @example "@siby369" - Users can install components with: `npx shadcn add @siby369/wheel-picker`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace: process.env.REGISTRY_NAMESPACE || "@siby369",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://Siby.com/r/{name}.json" resolves to "https://Siby.com/r/wheel-picker.json"
   ...
   */
  namespaceUrl:
    process.env.REGISTRY_NAMESPACE_URL || "https://Siby.com/r/{name}.json",
}
