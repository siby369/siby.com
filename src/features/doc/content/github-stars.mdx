...
image: https://assets.Siby.com/images/blog/github-stars.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://Siby.com/r/github-stars.json"
/>
...
```bash
npx shadcn add @siby369/github-stars
```
...
```tsx
<GithubStars repo="siby369/Siby.com" stargazersCount={1050} />
```
