...
image: https://assets.Siby.com/images/blog/awesome-terminal.webp
...
Reference: https://github.com/siby369/siby369.zsh-theme

```bash
git clone git@github.com:siby369/siby369.zsh-theme.git ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/themes/siby369.zsh-theme
```

**Activate the theme**

```bash title="~/.zshrc"
ZSH_THEME="siby369.zsh-theme/siby369"
```
